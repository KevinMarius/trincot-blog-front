...
export default function TopMain() {
    return (
        <div className='grid grid-cols-4 grid-rows-2 w-[100%] pt-4 px-6 gap-1 my-4'>
            <div className='col-span-full group row-span-1 hover:bg-blend-darken md:row-span-2 relative md:col-span-2'>
                ...
                <div className='duration-300  h-full bg-blend-lighten md:hover:bg-blend-darken'>
                    <img className='object-cover h-full transform duration-300' src={process.env.PUBLIC_URL + 'max-lissenden-tJxu4j4-T4o-unsplash.png'} alt="1" />
                </div>
            </div>
            <div className='col-span-full group md:col-span-1 md:row-span-1 relative h-full'>
                <h6 className='text-xl text-white absolute z-10 m-3 px-3 py-1 font-medium bg-purple-600 rounded-tl-md rounded-br-md'>Mercato</h6>
                <h4 className='absolute bottom-10 md:group-hover:bottom-12 transition-all duration-500 left-2 font-semibold text-xl text-white z-10'>Transfert de Mbappe</h4>
                ...
                <div className='duration-300 h-full bg-blend-lighten md:hover:bg-blend-darken'>
                    <img className='object-cover bg-blend-lighten md:hover:bg-blend-darken h-full transform duration-300' src={process.env.PUBLIC_URL + 'eilis-garvey-4x6aA37sMPg-unsplash.png'} alt="1" />
                </div>
            </div>
            <div className='col-span-full group md:col-span-1 md:row-span-1 relative h-full'>
                <h6 className='text-xl text-white absolute z-10 m-3 px-3 py-1 font-medium bg-purple-600 rounded-tl-md rounded-br-md'>Mercato</h6>
                ...
                <div className='duration-300 h-full bg-blend-lighten md:hover:bg-blend-darken'>
                    <img className='object-cover bg-blend-lighten md:hover:bg-blend-darken h-full transform duration-300' src={process.env.PUBLIC_URL + 'hi-estudio-EJujExKf0-o-unsplash.png'} alt="2" />
                </div>
            </div>
            <div className='col-span-full group md:col-span-1 md:row-span-1 relative h-full'>
                <h6 className='text-xl text-white absolute z-10 m-3 px-3 py-1 font-medium bg-purple-600 rounded-tl-md rounded-br-md'>Mercato</h6>
                ...
                <div className='duration-300 h-full bg-blend-lighten md:hover:bg-blend-darken'>
                    <img className='object-cover bg-blend-lighten md:hover:bg-blend-darken h-full transform duration-300' src={process.env.PUBLIC_URL + 'ilya-O0hE1cmbbkw-unsplash.png'} alt="3" />
                </div>
            </div>
            <div className='col-span-full group md:col-span-1 md:row-span-1 relative h-full'>
                <h6 className='text-xl text-white absolute z-10 m-3 px-3 py-1 font-medium bg-purple-600 rounded-tl-md rounded-br-md'>Mercato</h6>
